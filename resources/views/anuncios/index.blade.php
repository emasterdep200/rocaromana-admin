        ...
        <div class="card">
            <div class="card-header">
                <div class="col-sm-12 d-flex justify-content-end">
                    ...
                    <a class="btn btn-primary me-1 mb-1" data-bs-toggle="modal" data-bs-target="#addAnuncio">Agregar
                        Anuncio</a>
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-borderless" aria-describedby="mydesc" class='table-striped'
                            id="table_list" data-toggle="table" data-url="{{ url('anuncios_listing') }}"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" data-field="titulo" data-sortable="true" data-align="center">Titulo
                                    </th>
                                    <th scope="col" data-field="estado" data-sortable="true" data-align="center">Estado
                                    </th>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="{{ url('anuncio_create') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="image" id="imagen" accept="image/*"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" name="link" id="link"
                                placeholder="Ingresa el link" required>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="{{ url('anuncio_update') }}" enctype="multipart/form-data"
                        name="update">
                        @csrf
    ...
    <script>
        window.actionEvents = {
            'click .editdata': function(e, value, row, index) {
                ...
                $('form[name=update] img[rel=current_image]').attr('src',
                    `https://admin.rocaromana.com/images/publicity/${row.imagen}`);

            },
            'click .deletedata': function(e, value, row, index) {
                Swal.fire({
                    title: '¿Estás seguro?',
                    text: "¿Deseas eliminar este anuncio?",
                    icon: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.error == false) {
                                    Swal.fire(
                                        '¡Eliminado!',
                                        response.message || 'El anuncio ha sido eliminado correctamente.',
                                        'success'
                                    );
                                } else {
                                    Swal.fire(
                                        'Error',
                                        response.message || 'No se pudo eliminar el anuncio.',
                                        'error'
                                    );
                                }
                                
                                // Refrescar la tabla después de mostrar el mensaje
                                setTimeout(function() {
